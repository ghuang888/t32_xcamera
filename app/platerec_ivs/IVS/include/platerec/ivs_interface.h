...
/**
 * @fn IMPIVSInterface *OcrDetInterfaceInit(void *param)
 *
 * OCR检测接口初始化结构体
 *
 * @param[in] OCR检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回OCR检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *OcrDetInterfaceInit(void* param);

/**
 * @fn void OcrDetInterfaceExit(IMPIVSInterface *inf)
 *
 * OCR检测接口去初始化结构体
 *
 * @inf[in] OCR检测接口结构体指针句柄
 *
 * @attention 无。
 */
void OcrDetInterfaceExit(IMPIVSInterface *inf);


IMPIVSInterface *OcrrecInterfaceInit(void* param);
void OcrrecInterfaceExit(IMPIVSInterface *inf);
...
/**
 * @fn IMPIVSInterface *ScancodeInterfaceInit(void *param)
 *
 * 车牌识别接口初始化结构体
 *
 * @inf[in] 车牌识别接口初始化参数
...
IMPIVSInterface *ScancodeInterfaceInit(void *param);

/**
 * @fn void ScancodeInterfaceExit(IMPIVSInterface *inf)
 *
 * 车牌识别去初始化结构体句柄
 *
 * @inf[in] 车牌识别接口结构体句柄
 ...
 * @attention 无
 */
void ScancodeInterfaceExit(IMPIVSInterface *inf);
/**
 * @fn IMPIVSInterface *ScancodeInterfaceInit(void *param)
 *
 *
