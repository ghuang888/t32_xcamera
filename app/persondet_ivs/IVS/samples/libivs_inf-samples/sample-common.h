...
/* first sensor */
#define FIRST_SNESOR_NAME            "sc500ai" //"gc2053"            //sensor name (match with snesor driver name)
#define FIRST_I2C_ADDR                0x30 //0x37            //sensor i2c address
...
#define    FIRST_MCLK                    IMPISP_SENSOR_MCLK0 //IMPISP_SENSOR_MCLK1                //sensor clk source (mclk0/mclk1/mclk2)
