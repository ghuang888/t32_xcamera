...
#define PERSONDET_VERSION_NUM 0x00000106 /*2021-1129*/
 ...
 * 人形检测输入结构体
     >*/
typedef struct {
        unsigned int max_person_box; /**< 人形检测结果最多的框数量，若图片中检测目标多于max_person_box则随机输出max_person_box个框 >*/
        const char* model_path; /**< 人形检测模型路径 >*/
        int sense; /**< 检测灵敏度 0~6 0:最不灵敏，误检率最低，正检会下降 6:最灵敏，正检率最高，误检相应增加 default:5 >*/
        int detdist; /**< reserved >*/
