...
RTSPClient::RTSPClient(UsageEnvironment& env, char const* rtspURL,
  ...
  : Medium(env),
    ...
    fTLS(*this) {
		//printf("############ %s,%d: %p\n", __func__, __LINE__, rtspURL);
  setBaseURL(rtspURL);
		//printf("############ %s,%d: %p\n", __func__, __LINE__, fBaseURL);
...
unsigned RTSPClient::sendRequest(RequestRecord* request) {
  ...
  do {
	...
	//printf("#### %s,%d: %p\n", __func__, __LINE__, request->commandName());
	//printf("#### %s,%d: %p\n", __func__, __LINE__, cmdURL);
	//printf("#### %s,%d: %p\n", __func__, __LINE__, protocolStr);
	//printf("#### %s,%d: %p\n", __func__, __LINE__, authenticatorStr);
	//printf("#### %s,%d: %p\n", __func__, __LINE__, extraHeaders);
	//printf("#### %s,%d: %p\n", __func__, __LINE__, contentLengthHeader);
