...
typedef enum {
    ...
    IVS_PERSONVEHICLE_DETECT,                       /**< DL人车检测 */
    IVS_PERSONVEHICLEVLIGHT_DETECT,                       /**< DL人车检测 */
    IVS_PERSONVEHICLEPARCEL_DETECT,                       /**< DL人车检测 */
    IVS_PERSONVEHICLEEBIKE_DETECT,                       /**< DL人车ebike检测 */
    IVS_FACEPERSON_DETECT,                          /**< DL人脸人形宠物(猫狗)检测 */
    IVS_PERSONVEHICLEPET_DETECT,                       /**< DL人车宠物(猫狗)检测 */
...
/**
 * @fn IMPIVSInterface *PersonvehicleDetInterfaceInit(void *param)
 *
 * DL人车检测接口初始化结构体
 *
 * @param[in] DL人车检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL人车检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *PersonvehicleDetInterfaceInit(void* param);

/**
 * @fn void PersonvehicleDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL人车检测接口去初始化结构体
 *
 * @inf[in] DL人车检测接口结构体指针句柄
 *
 * @attention 无。
 */
void PersonvehicleDetInterfaceExit(IMPIVSInterface *inf);

/**
 * @fn IMPIVSInterface *PersonvehicleDetInterfaceInit(void *param)
 *
 * DL人车vlight检测接口初始化结构体
 *
 * @param[in] DL人车vlight检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL人车vlight检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *PersonvehiclevlightDetInterfaceInit(void* param);

/**
 * @fn void PersonvehiclevlightDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL人车vlight检测接口去初始化结构体
 *
 * @inf[in] DL人车vlight检测接口结构体指针句柄
 *
 * @attention 无。
 */
void PersonvehiclevlightDetInterfaceExit(IMPIVSInterface *inf);

/**
 * @fn IMPIVSInterface *PersonvehicleparcelDetInterfaceInit(void *param)
 *
 * DL人车parcel检测接口初始化结构体
 *
 * @param[in] DL人车parcel检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL人车parcel检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *PersonvehicleparcelDetInterfaceInit(void* param);

/**
 * @fn void PersonvehicleparcelDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL人车parcel检测接口去初始化结构体
 *
 * @inf[in] DL人车parcel检测接口结构体指针句柄
 *
 * @attention 无。
 */
void PersonvehicleparcelDetInterfaceExit(IMPIVSInterface *inf);
 ...
 * DL人车ebike检测接口初始化结构体
 *
 * @param[in] DL人车ebike检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL人车ebike检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *PersonvehicleebikeDetInterfaceInit(void* param);

/**
 * @fn void PersonvehicleebikeDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL人车ebike检测接口去初始化结构体
 *
 * @inf[in] DL人车ebike检测接口结构体指针句柄
 *
 * @attention 无。
 */
void PersonvehicleebikeDetInterfaceExit(IMPIVSInterface *inf);

/**
 * @fn IMPIVSInterface *PersonvehiclepetDetInterfaceInit(void *param)
 *
 * DL人车宠物(猫狗)检测接口初始化结构体
 *
 * @param[in] DL人车宠物(猫狗)检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL人车宠物(猫狗)检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *PersonvehiclepetDetInterfaceInit(void* param);

/**
 * @fn void PersonvehiclepetDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL人车宠物(猫狗)检测接口去初始化结构体
 *
 * @inf[in] DL人车车宠物(猫狗)检测接口结构体指针句柄
 *
 * @attention 无。
 */
void PersonvehiclepetDetInterfaceExit(IMPIVSInterface *inf);
