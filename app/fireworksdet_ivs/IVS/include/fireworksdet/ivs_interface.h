...
/**
 * @fn IMPIVSInterface *FireworksDetInterfaceInit(void *param)
 *
 * DL烟火检测接口初始化结构体
 *
 * @param[in] DL烟火检测初始化参数
 *
 * @retval NULL 失败
 * @retval 非NULL 初始化成功，返回DL烟火检测接口结构体指针句柄
 *
 * @attention 无。
 */

IMPIVSInterface *FireworksDetInterfaceInit(void* param);

/**
 * @fn void FireworksDetInterfaceExit(IMPIVSInterface *inf)
 *
 * DL烟火检测接口去初始化结构体
 *
 * @inf[in] DL烟火检测接口结构体指针句柄
 *
 * @attention 无。
 */
void FireworksDetInterfaceExit(IMPIVSInterface *inf);
